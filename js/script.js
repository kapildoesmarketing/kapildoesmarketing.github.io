...
if (testimonialsItem) {
  for (let i = 0; i < testimonialsItem.length; i++) {
    ...
    testimonialsItem[i].addEventListener("click", function () {
      ...
      // Designed by Kapil Pidhwani: Dynamically updates the details modal with corresponding date and professional subtitle/role when a testimonial card is clicked.
      const subtitle = this.querySelector("[data-testimonials-subtitle]");
      const modalSubtitle = document.querySelector("[data-modal-subtitle]");
      if (subtitle && modalSubtitle) {
